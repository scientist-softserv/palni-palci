...
module Hyrax
  module CollectionsControllerBehavior
    ...
    def show
      Rails.logger.info("####################################")
      Rails.logger.info("HYRAX::COLLECTIONS_CONTROLLER_BEHAVIOR SHOW METHOD")
      Rails.logger.info("####################################")
    ...
    def member_works
      ...
      Rails.logger.info("###################################")
      Rails.logger.info("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
      # Rails.logger.info(collection_member_service.inspect) #Hyrax::Collections::CollectionMemberSearchService
      Rails.logger.info("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
