...
class SolrDocument
  ...
  attribute :table_of_contents, Solr::String, 'table_of_contents_tesi'
  attribute :additional_information, Solr::String, 'additional_information_tesi'
  attribute :rights_holder, Solr::String, 'rights_holder_tesi'
  attribute :rights_notes, Solr::String, 'rights_notes_tesi'
  attribute :oer_size, Solr::String, 'oer_size_tesi'
  attribute :accessibility_summary, Solr::String, 'accessibility_summary_tesi'
