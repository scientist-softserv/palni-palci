# Override from hyrax 2.5.1 to eliminate guest accounts from appearing
# on the admin dashboard new users partial
...
module Hyrax
  module Statistics
    ...
    class SystemStats
      ...
      # Override from hyrax 2.5.1 to add exclude_guests scope
      ...
      def recent_users
        ...
        return ::User.exclude_guests.order('created_at DESC').limit(limit) if start_date.blank?
