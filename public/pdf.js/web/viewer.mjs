...
class GenericExternalServices extends _app_js__WEBPACK_IMPORTED_MODULE_0__.DefaultExternalServices {
  ...
  static async createL10n() {
    return new _genericl10n_js__WEBPACK_IMPORTED_MODULE_4__.GenericL10n(_app_options_js__WEBPACK_IMPORTED_MODULE_1__.AppOptions.get("locale") || "en-US");
  }
...
/* harmony import */ var _l10n_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4065);



class GenericL10n extends _l10n_js__WEBPACK_IMPORTED_MODULE_2__.L10n {
  constructor(lang) {
    super({
      lang
    });
...
const pdfjsVersion = '4.0.234';
const pdfjsBuild = '44cde3ccc';
const AppConstants = {
