...
RSpec.describe Hyrax::PaperOrReportPresenter do
    ...
    describe "#attribute_to_html" do
      ...
      context "with a field that doesn't exist" do
        it "logs a warning" do
          ...
          expect(Rails.logger).to receive(:warn).with('Hyrax::PaperOrReportPresenter attempted to render restrictions, but no method exists with that name.')
